...
function MainPage() {
    ...
    const cards = [
      ...
      const Card = ({ title, copy, button }) => (
        <div className="card-currently"> {/* Updated class name */}
          <div className="content-currently"> {/* Updated class name */}
            <h2 className="title-currently">{title}</h2> {/* Updated class name */}
            <p className="copy-currently">{copy}</p> {/* Updated class name */}
            <a className="btn-currently">{button}</a> {/* Updated class name */}
          </div>
        </div>
      );
    ...
    return (
        <div>
            ...
            <div className="btns">
            <a
    className={`blue-btn ${locationMenuOpen ? 'active' : ''}`}
    href="#"
...
<a
    className={`blue-btn ${genreMenuOpen ? 'active' : ''}`}
    href="#"
